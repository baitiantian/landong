...
import static com.jinan.ladongjiguan.djj8plus.publicClass.Dp2Px.dip2px;
...
public class HRecyclerView extends RelativeLayout {
    ...
    private View createHeadLayout() {
        ...
        headLayout.setBackgroundColor(getResources().getColor(R.color.blue_5));
        return headLayout;
    }
    ...
    private View createMoveRecyclerView() {
        ...
        if (null != mAdapter) {
            if (mAdapter instanceof HRecyclerAdapter) {
                mRecyclerView.setAdapter((HRecyclerAdapter) mAdapter);
                mMoveViewList = ((HRecyclerAdapter) mAdapter).getMoveViewList();
            }
        }
    ...
    private TextView addListHeaderTextView(String headerName, int width, LinearLayout leftLayout) {
        ...
        textView.setTextColor(getResources().getColor(R.color.white_0));
