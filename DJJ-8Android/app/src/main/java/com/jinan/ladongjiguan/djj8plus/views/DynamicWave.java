...
public class DynamicWave extends View {
    ...
    // 波纹颜色
    private static final int WAVE_PAINT_COLOR_1 = R.color.white_1 ;
    private static final int WAVE_PAINT_COLOR_2 = R.color.white_1;
    // y = Asin(wx+b)+h
    ...
    public DynamicWave(Context context, AttributeSet attrs) {
        ...
        // 设置画笔颜色
        mWavePaintOne.setColor(getResources().getColor(WAVE_PAINT_COLOR_1));
        mWavePaintTwo.setColor(getResources().getColor(WAVE_PAINT_COLOR_2));
