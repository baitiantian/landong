...
import com.jinan.ladongjiguan.djj8plus.utils.Constants;
import com.jinan.ladongjiguan.djj8plus.utils.UiUtils;
...
public class ClockViewByPath extends View {
    ...
    private static final int DEFAULT_CLOCK_SCALE_LINE_WIDTH = 1;
    private static final int DEFAULT_CLOCK_SCALE_LINE_HEIGHT = 6;
    ...
    private static final int DEFAULT_DIGITAL_TIME_TEXT_SIZE = 25;
    private static final String DEFAULT_DEFAULT_DIGITAL_TIME_TEXT = "00:00";

    private static final int DEFAULT_CLOCK_POINT_COLOR = R.color.red_2;
    private static final int DEFAULT_CLOCK_POINT_RADIUS = 4;
    ...
    private void init() {
        ...
        mLastDigitalTimeStr = String.format("%02d:%02d", mCalendar.get(Calendar.HOUR_OF_DAY),
