...
import com.lunduimohao.landongjiguang.lunduimohao.PublicClass.DemoBase;
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        title_layout.setText("踏面轮廓");
        /**
         * 返回键
         * */
        findViewById(R.id.examine_page_back).setOnClickListener(new View.OnClickListener() {
            @Override
...
//        mChart.centerViewTo(20, 50, AxisDependency.LEFT);
    ...
    private void setData(int count, float range) {
        ...
        if (mChart.getData() != null &&
            ...
            set1 = new LineDataSet(values, "轮廓数据");
