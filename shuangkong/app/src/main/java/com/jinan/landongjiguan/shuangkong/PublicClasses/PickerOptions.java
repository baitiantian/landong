package com.jinan.landongjiguan.shuangkong.PublicClasses;
...
import com.jinan.landongjiguan.shuangkong.listener.CustomListener;
import com.jinan.landongjiguan.shuangkong.listener.OnOptionsSelectChangeListener;
import com.jinan.landongjiguan.shuangkong.listener.OnOptionsSelectListener;
import com.jinan.landongjiguan.shuangkong.listener.OnTimeSelectChangeListener;
import com.jinan.landongjiguan.shuangkong.listener.OnTimeSelectListener;
...
public class PickerOptions {
    ...
    public PickerOptions(int buildType) {
        if (buildType == TYPE_PICKER_OPTIONS) {
            layoutRes = R.layout.layout_pickerview_options;
        } else {
            layoutRes = R.layout.layout_pickerview_time;
        }
    }
