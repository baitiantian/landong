...
public class CheckUpDateListAdapter extends BaseAdapter {
    ...
    public CheckUpDateListAdapter(Context context,  List<HashMap<String, Object>> list,
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (holder == null) {
            holder = new ViewHold();
            if (view == null) {
                view = inflater.inflate(R.layout.check_up_list_02_item, null);
                LinearLayout linearLayout = (LinearLayout)view.findViewById(R.id.l_check_box);
                linearLayout.setVisibility(View.VISIBLE);
                LinearLayout linearLayout_01 = (LinearLayout)view.findViewById(R.id.l_check);
                linearLayout_01.setVisibility(View.INVISIBLE);
            }
            holder.tv1 = (TextView) view.findViewById(R.id.tx_add_check_up_01);
            holder.tv2 = (TextView) view.findViewById(R.id.tx_add_check_up_02);
