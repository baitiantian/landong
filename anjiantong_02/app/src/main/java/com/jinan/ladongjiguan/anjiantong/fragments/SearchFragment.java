...
import com.jinan.ladongjiguan.anjiantong.activity.AccidentInvestigationMainActivity;
import com.jinan.ladongjiguan.anjiantong.activity.CountActivity;
import com.jinan.ladongjiguan.anjiantong.activity.PersonnelManagementActivity;
...
public class SearchFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.search_main_layout,
                container, false);
        getData();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.l_search_main_01://执法人员
                //判断权限
                if (headShip.equals("安监站监控员") ||
                        ...
                        headShip.equals("1")) {
                    Toast.makeText(getContext(), "您没有查看的权限", Toast.LENGTH_SHORT).show();
                } else {
                ...
                break;
            case R.id.l_search_main_02://执法统计
                //判断权限
                if (headShip.equals("安监站监控员") ||
                        headShip.equals("驻矿员") ||
                        headShip.equals("其他") ||
                ...
                break;
            case R.id.l_search_main_03://事故调查
                intent.setClass(getContext(), AccidentInvestigationMainActivity.class);
