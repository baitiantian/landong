...
public class ProblemListAdapter extends BaseAdapter {
    ...
    public ProblemListAdapter(Context context,  List<HashMap<String, Object>> list,
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        if (holder == null) {
            ...
            holder.tv1 = (TextView) view.findViewById(R.id.tx_problem_01);
            holder.tv2 = (TextView) view.findViewById(R.id.tx_problem_02);
            holder.tv3 = (TextView) view.findViewById(R.id.tx_problem_03);
            holder.tv4 = (TextView) view.findViewById(R.id.tx_problem_04);
            holder.tv5 = (TextView) view.findViewById(R.id.tx_problem_05);
            holder.tv6 = (TextView) view.findViewById(R.id.tx_problem_06);
            holder.tv7 = (TextView) view.findViewById(R.id.tx_problem_07);
        ...
        if (map != null) {
            try {
                ...
                holder.tv6.setText(itemString);//检查人

                itemString = (String) map.get(keyString[6]);
