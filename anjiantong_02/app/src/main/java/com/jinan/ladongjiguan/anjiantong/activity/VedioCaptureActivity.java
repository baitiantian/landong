...
import com.jinan.ladongjiguan.anjiantong.helper.CameraHelper;
...
public class VedioCaptureActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    class MediaPrepareTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            if (!result) {
                VedioCaptureActivity.this.finish();
            }
