...
public class SearchView extends LinearLayout implements View.OnClickListener {
    ...
    public CharSequence getEtInput() {
        return etInput.getText();
    }

    public SearchView(Context context, EditText etInput) {
        super(context);
...
//                etInput.setSelection(text.length());
     ...
     * 设置热搜版提示 adapter
     */
    public void setTipsHintAdapter(ArrayAdapter<CharSequence> adapter) {
     ...
     * 设置自动补全adapter
     */
    public void setAutoCompleteAdapter(ArrayAdapter<CharSequence> adapter) {
